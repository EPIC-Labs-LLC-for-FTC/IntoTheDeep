...
@Autonomous(name = "Right_SP_SP")
public class Right_SP_SP extends OpMode {
    ...
    private PathChain r1Dp, r2dp, rdS1p, dS1p, brdS1p, rdS2p, dS2p, brdS2p, rds3p, dS3p, sSP2p, pSP3, sSP3p, pSP4, sSP4p, pSP5, sSP5p;
