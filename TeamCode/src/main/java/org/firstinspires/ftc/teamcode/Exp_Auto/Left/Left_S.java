...
public class Left_S extends LinearOpMode {
    ...
    private final Pose scoreSPose = new Pose(18, 126, Math.toRadians(-45));
    ...
    private PathChain scorePreload, gs1, ds1, gs2, ds2, gs3, ds3, readyPark, park;
    ...
    public void buildPaths() {
        ...
        scorePreload = follower.pathBuilder()
                .addPath(new BezierLine(new Point(startPose), new Point(scoreSPose)))
                .setConstantHeadingInterpolation(Math.toRadians(0))
                .build();

        gs1 = follower.pathBuilder()

                .addPath(new BezierLine(new Point(scoreSPose), new Point(grabS1)))
                .setConstantHeadingInterpolation(Math.toRadians(0))
                .build();
